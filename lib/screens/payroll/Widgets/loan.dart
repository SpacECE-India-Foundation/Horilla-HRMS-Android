      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                _titleAndValueBox('Loan', 'Loan Title', 16.0),
                SizedBox(width: 60),
                _titleAndValueBox('Provided Date', '14/1/25', 20.0),
              ],
            ),
            SizedBox(height: 16),
            Row(
              children: [
                _titleAndValueBox('Amount', '\$1,053', 16),
                SizedBox(width: 60),
                _titleAndValueBox('Installment Date', '14/1/25', 20.0),
              ],
            ),
