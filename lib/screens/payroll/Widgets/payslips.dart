...
class PayslipsWidgets extends StatefulWidget {
  const PayslipsWidgets({super.key});

  @override
  State<PayslipsWidgets> createState() => _PayslipsWidgetsState();
}

class _PayslipsWidgetsState extends State<PayslipsWidgets> {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                _titleAndValueBox('Gross Pay', '\$1,253', 16.0),
                SizedBox(width: 60),
                _titleAndValueBox('Deduction', '\$200', 20.0),
              ],
            ),
            SizedBox(height: 16),
            Row(
              children: [
                _titleAndValueBox('Net Pay', '\$1,053', 16),
                SizedBox(width: 60),
                _titleAndValueBox('Batch', 'Paid Monthly', 20.0),
              ],
            ),
...
Widget _titleAndValueBox(String title, String value, double valueFontSize) {
  return Column(
